...
if ( ! function_exists( 'perfect_portfolio_customizer_theme_info' ) ) :
	...
	function perfect_portfolio_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'perfect-portfolio' ), esc_url( __( 'https://demo.rarathemes.com/perfect-portfolio/', 'perfect-portfolio' ) ), esc_html__( 'Click here.', 'perfect-portfolio' ) );

	    $theme_info .= '</p><p>';

	    /* translators: 1: string, 2: documentation url, 3: string */
	    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'perfect-portfolio' ), esc_url( 'https://rarathemes.com/documentation/perfect-portfolio/' ), esc_html__( 'Click here.', 'perfect-portfolio' ) );
